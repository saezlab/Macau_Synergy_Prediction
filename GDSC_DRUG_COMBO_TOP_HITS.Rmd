...
# We create a folder where the results are going to be stored
dir.create(paste0(path,"/MACAU_PROJECT/PLOTS/DRUG_COMBO_PREDICTION/target_progeny_profile/"),recursive = TRUE)
